...
-->
<template>
  <div id="get-in-touch" class="relative bg-white">
        ...
        <div class="max-w-lg mx-auto">
          ...
          <dl class="mt-8 text-base text-gray-500">
            <div>
              ...
              <dd>
                <p>31531 Rancho Viejo Road</p>
                <p>San Juan Capistrano, California</p>
                <p>United States</p>
              </dd>
            </div>
            <div class="mt-6">
          ...
          <p class="mt-6 text-base text-gray-500">
            Looking for our open source projects?
            {{ ' ' }}
            <a href="#" class="font-medium text-gray-700 underline">View GitHub Repo</a>
          </p>
        </div>
      </div>
        ...
        <div class="max-w-lg mx-auto lg:max-w-none">
          <form action="#" method="POST" class="grid grid-cols-1 gap-y-6">
            ...
            <div>
              ...
              <textarea id="message" name="message" rows="4" class="block w-full shadow-sm py-3 px-4 placeholder-gray-500 focus:ring-indigo-500 focus:border-indigo-500 border border-gray-300 rounded-md" placeholder="Tell us about your project" />
            </div>
            <div>
